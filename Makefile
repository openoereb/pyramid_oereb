...
.PHONY: tests
tests: ${VENV_ROOT}/requirements-timestamp test-core test-contrib-data_sources-standard test-contrib-data_sources-interlis test-contrib-print_proxy-mapfish_print test-contrib-stats
