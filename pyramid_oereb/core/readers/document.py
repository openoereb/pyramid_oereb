...
class DocumentReader(object):
    """
    The central reader for the document definitions. It is directly bound to a so called source
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.core.sources.document.DocumentBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-core-sources-document-documentbasesource`.
    ...
    def read(self, office_records):
        ...
        Note:
            ...
            :ref:`api-pyramid_oereb-core-records-documents-documentrecord`. Otherwise the API like way
        ...
        """
        return self._source_.read(office_records)
