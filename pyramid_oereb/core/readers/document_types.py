    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.core.sources.document_types.DocumentTypesBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-core-sources-document_types-documenttypesbasesource`.
