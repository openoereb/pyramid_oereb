...
class OfficeReader(object):
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.core.sources.office.OfficeBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-core-sources-office-officebasesource`.
    ...
    def read(self):
        ...
        Note:
            ...
            :ref:`api-pyramid_oereb-core-records-office-officerecord`. Otherwise the API like way
