...
class ThemeDocumentReader(object):
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.core.sources.theme_document.ThemeDocumentBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-core-sources-theme_document-ThemeDocumentBaseSource`.
    ...
    def read(self):
        ...
        Note:
            ...
            :ref:`api-pyramid_oereb-core-records-theme_document-ThemeDocumentRecord`. Otherwise the
