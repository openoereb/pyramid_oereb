...
class DataIntegrationReader(object):
    """
    The central reader for the data integration definitions. It is directly bound to a so called source
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path (str or
                pyramid_oereb.core.sources.data_integration.DataIntegrationBaseSource):
                ...
                :ref:`api-pyramid_oereb-core-sources-data_integration-dataintegrationbasesource`.
    ...
    def read(self):
        ...
        Note:
            ...
            must be a list of :ref:`api-pyramid_oereb-core-records-data_integration-dataintegrationbaserecord`.
