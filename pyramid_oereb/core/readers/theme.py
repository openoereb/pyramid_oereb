...
class ThemeReader(object):
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.core.sources.theme.ThemeBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-core-sources-theme-themebasesource`.
    ...
    def read(self):
        ...
        Note:
            ...
            :ref:`api-pyramid_oereb-core-records-theme-themerecord`. Otherwise the API like way
