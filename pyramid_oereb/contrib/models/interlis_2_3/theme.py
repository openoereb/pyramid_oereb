...
def model_factory(schema_name, pk_type, srid, db_connection):
    ...
    class LegendEntry(Base):
        ...
        Attributes:
            ...
            legend_text_de (text): Mapping of interlis type: LocalisationCH_V1.MultilingualText.
            legend_text_fr (text): Mapping of interlis type: LocalisationCH_V1.MultilingualText.
            legend_text_it (text): Mapping of interlis type: LocalisationCH_V1.MultilingualText.
            legend_text_rm (text): Mapping of interlis type: LocalisationCH_V1.MultilingualText.
            legend_text_en (text): Mapping of interlis type: LocalisationCH_V1.MultilingualText.
