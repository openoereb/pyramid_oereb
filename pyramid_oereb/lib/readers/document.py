...
class DocumentReader(object):
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.lib.sources.document.DocumentBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-lib-sources-document-documentbasesource`.
    ...
    def read(self, office_records):
        ...
        .. note:: If you subclass this class your implementation needs to offer this method in the same
            ...
            :ref:`api-pyramid_oereb-lib-records-documents-documentrecord`. Otherwise the API like way
