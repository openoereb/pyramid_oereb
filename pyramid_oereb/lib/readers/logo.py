...
class LogoReader(object):
    """
    The central reader for the logo images. It is directly bound to a so called source
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.lib.sources.logo.LogoBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-lib-sources-logo-logobasesource`.
    ...
    def read(self):
        ...
        .. note:: If you subclass this class your implementation needs to offer this method in the same
            ...
            :ref:`api-pyramid_oereb-lib-records-logo-logorecord`. Otherwise the API like way
