...
class DocumentTypeReader(object):
    """
    The central reader for the document type definitions. It is directly bound to a so called source
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.lib.sources.document_types.DocumentTypesBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-lib-sources-document_types-documenttypesbasesource`.
    ...
    def read(self):
        ...
        .. note:: If you subclass this class your implementation needs to offer this method in the same
            ...
            :ref:`api-pyramid_oereb-lib-records-document_types-documenttyperecord`. Otherwise the API like way
