...
class LawStatusReader(object):
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.lib.sources.lawstatus.LawStatusBaseSource): The path to
                ...
                :ref:`api-pyramid_oereb-lib-sources-lawstatus-lawstatusbasesource`.
    ...
    def read(self):
        ...
        .. note:: If you subclass this class your implementation needs to offer this method in the same
            ...
            :ref:`api-pyramid_oereb-lib-records-lawstatus-lawstatusrecord`.
            Otherwise the API like way the server works would be broken.
        params (pyramid_oereb.views.webservice.Parameter): The parameters of the extract request.
        Returns:
            list of pyramid_oereb.lib.records.lawstatus.LawStatusRecord:
