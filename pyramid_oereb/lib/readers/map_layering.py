...
class MapLayeringReader(object):
    """
    The central reader for the map layering definitions. It is directly bound to a so called source
    ...
    def __init__(self, dotted_source_class_path, **params):
        ...
        Args:
            dotted_source_class_path
                (str or pyramid_oereb.lib.sources.map_layering.MapLayeringBaseSource): The path to
    ...
    def read(self):
        ...
        .. note:: If you subclass this class your implementation needs to offer this method in the same
            ...
            :ref:`api-pyramid_oereb-lib-records-map_layering-maplayeringrecord`. Otherwise the API like way
