...
class DocumentTypesBaseSource(Base):
    ...
    Attributes:
        records (list of pyramid_oereb.lib.records.document_types.DocumentTypeRecord): List of document type records.
    """
    _record_class_ = DocumentTypeRecord

    def read(self, params):
        """
        Every document type source has to implement a read method. This method must accept no parameters. Because
        ...
        Args:
            params (pyramid_oereb.views.webservice.Parameter): The parameters of the extract request (e.g. language).
        """
