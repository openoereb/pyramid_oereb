...
class DataIntegration(Base):
    ...
    Attributes:
        ...
        office (pyramid_oereb.standard.models.motorways_project_planing_zones.Office): The actual office instance which the id
            points to.
    """
    __table_args__ = {'schema': 'motorways_project_planing_zones'}
...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        base (pyramid_oereb.standard.models.motorways_project_planing_zones.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.motorways_project_planing_zones.DocumentBase):
            The dedicated relation to the document instance from database.
    """
