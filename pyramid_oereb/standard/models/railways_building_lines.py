...
class DataIntegration(Base):
    ...
    Attributes:
        ...
        office (pyramid_oereb.standard.models.railways_building_lines.Office): The actual office instance which the id
            points to.
    """
    __table_args__ = {'schema': 'railways_building_lines'}
...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        base (pyramid_oereb.standard.models.railways_building_lines.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.railways_building_lines.DocumentBase):
            The dedicated relation to the document instance from database.
    """
