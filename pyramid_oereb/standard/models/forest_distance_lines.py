...
class DataIntegration(Base):
    ...
    Attributes:
        ...
        office (pyramid_oereb.standard.models.forest_distance_lines.Office): The actual office instance which the id
            points to.
    """
    __table_args__ = {'schema': 'forest_distance_lines'}
...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        base (pyramid_oereb.standard.models.forest_distance_lines.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.forest_distance_lines.DocumentBase):
            The dedicated relation to the document instance from database.
    """
