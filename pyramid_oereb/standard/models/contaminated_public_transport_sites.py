...
class DataIntegration(Base):
    ...
    Attributes:
        ...
        office (pyramid_oereb.standard.models.contaminated_public_transport_sites.Office): The actual office instance which the id
            points to.
    """
    __table_args__ = {'schema': 'contaminated_public_transport_sites'}
...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        base (pyramid_oereb.standard.models.contaminated_public_transport_sites.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.contaminated_public_transport_sites.DocumentBase):
            The dedicated relation to the document instance from database.
    """
