...
class DataIntegration(Base):
    ...
    Attributes:
        ...
        office (pyramid_oereb.standard.models.railways_project_planning_zones.Office): The actual office instance which the id
            points to.
    """
    __table_args__ = {'schema': 'railways_project_planning_zones'}
...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        base (pyramid_oereb.standard.models.railways_project_planning_zones.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.railways_project_planning_zones.DocumentBase):
            The dedicated relation to the document instance from database.
    """
