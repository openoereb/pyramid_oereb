...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        base (pyramid_oereb.standard.models.airports_security_zone_plans.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.airports_security_zone_plans.DocumentBase):
            The dedicated relation to the document instance from database.
    """
