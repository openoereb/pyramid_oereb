...
class DataIntegration(Base):
    ...
    Attributes:
        ...
        office (pyramid_oereb.standard.models.groundwater_protection_sites.Office): The actual office instance which the id
            points to.
    """
    __table_args__ = {'schema': 'groundwater_protection_sites'}
...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        base (pyramid_oereb.standard.models.groundwater_protection_sites.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.groundwater_protection_sites.DocumentBase):
            The dedicated relation to the document instance from database.
    """
