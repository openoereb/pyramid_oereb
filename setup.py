...
setup(
    ...
    entry_points={
        ...
        'console_scripts': [
            ...
            'create_example_yaml = pyramid_oereb.dev.config.create_yaml:create_standard_yaml',
            'create_theme_tables = pyramid_oereb.contrib.data_sources.standard.create_tables:create_theme_tables',
            'drop_standard_tables = pyramid_oereb.contrib.data_sources.standard.drop_tables:drop_standard_tables',
            'create_legend_entries = pyramid_oereb.contrib.data_sources.standard.load_legend_entries:run',
            'import_federal_topic = pyramid_oereb.contrib.data_sources.standard.import_federal_topic:run',
