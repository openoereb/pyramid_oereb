...
=============================
Please follow the `instructions <https://github.com/pyramidoereb/pyramid_oereb/tree/master/cla>`__ and sign the CLA.
...
.. code-block:: shell
 ...
 git clone https://github.com/pyramidoereb/pyramid_oereb.git
 cd pyramid_oereb
...
-  Install the new version
   ...
   .. code-block:: shell
    ...
    .build\venv\Scripts\pip install git+https://github.com/pyramidoereb/pyramid_oereb.git@master#egg=pyramid_oereb
