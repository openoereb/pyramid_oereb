...
* Improvements to the calculation of the number of pages of the table of contents
* New parameter 'page_break_difference' allows customization of calculation of toc length
* Initialization of pyramid_oereb processor at beginning of application start resulting in performance improvements.
