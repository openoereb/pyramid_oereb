...
.. _api-pyramid_oereb-contrib-print_proxy:

.. automodule:: pyramid_oereb.contrib.print_proxy


.. _api-pyramid_oereb-contrib-print_proxy-mapfish_print:

.. automodule:: pyramid_oereb.contrib.print_proxy.mapfish_print


.. _api-pyramid_oereb-contrib-print_proxy-mapfish_print-renderer:

*Mapfish Print Renderer*
^^^^^^^^^^^^^^^^^^^^^^^^

.. autoclass:: pyramid_oereb.contrib.print_proxy.mapfish_print.Renderer
   :members:
   :inherited-members:

   .. automethod:: __init__

.. _api-pyramid_oereb-contrib-print_proxy-toc_pages:

.. automodule:: pyramid_oereb.contrib.print_proxy.toc_pages


.. _api-pyramid_oereb-contrib-print_proxy-toc_pages-tocpages:

*Toc Pages TocPages*
^^^^^^^^^^^^^^^^^^^^

.. autoclass:: pyramid_oereb.contrib.print_proxy.toc_pages.TocPages
   :members:
   :inherited-members:
...
.. _api-pyramid_oereb-contrib-print_proxy-xml_2_pdf-renderer:

*Xml 2 Pdf Renderer*
^^^^^^^^^^^^^^^^^^^^

.. autoclass:: pyramid_oereb.contrib.print_proxy.xml_2_pdf.Renderer
   :members:
   :inherited-members:
