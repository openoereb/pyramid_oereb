...
def test_create_standard_db():
    ...
    from pyramid_oereb.contrib.data_sources.standard.create_tables import create_tables_from_standard_configuration
...
def test_drop_tables():
    assert pyramid_oereb_test_yml is not None
    from pyramid_oereb.contrib.data_sources.standard.drop_tables import drop_tables_from_standard_configuration
